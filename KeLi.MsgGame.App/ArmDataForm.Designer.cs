...
namespace KeLi.MsgGame.App
{
    sealed partial class ArmDataForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.bpcProperty = new KeLi.GameComps.Part.BasePropertyCtrl();
            this.ftcTitle = new KeLi.GameComps.Part.FurnishTypeCtrl();
            this.mcBfwl = new KeLi.GameComps.Part.MagicCtrl();
            this.mcGyhd = new KeLi.GameComps.Part.MagicCtrl();
            this.mcFjzz = new KeLi.GameComps.Part.MagicCtrl();
            this.mcMosaic = new KeLi.GameComps.Part.MosaicCtrl();
            this.ascXytz = new KeLi.GameComps.Part.ArmSuitCtrl();
            this.lblFightPower = new System.Windows.Forms.Label();
            this.acAlchemy = new KeLi.GameComps.Part.AlchemyCtrl();
            this.SuspendLayout();
            // 
            // lblArmStory
            // 
