...
namespace KeLi.MsgGame.App
{
    sealed partial class MainForm
    {
        ...
        {
            this.mcMatch = new KeLi.GameComps.Page.MatchCtrl();
            this.atcTask = new KeLi.GameComps.Page.ActiveTaskCtrl();
            this.mcMsg = new KeLi.GameComps.Page.MsgCtrl();
            this.glcGamer = new KeLi.GameComps.Page.GamerListCtrl();
            this.rlcRoom = new KeLi.GameComps.Page.RoomListCtrl();
            this.mmcMenu = new KeLi.GameComps.Page.MainMenuCtrl();
            this.SuspendLayout();
            // 
            // mcMatch
            // 
