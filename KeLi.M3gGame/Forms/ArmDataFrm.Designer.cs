...
namespace KeLi.M3Game.Forms
{
    sealed partial class ArmDataFrm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.bpcProperty = new BasePropertyies();
            this.ftcTitle = new FurnishTypeComponent();
            this.mcBfwl = new MagicComponent();
            this.mcGyhd = new MagicComponent();
            this.mcFjzz = new MagicComponent();
            this.mcMosaic = new MosaicComponent();
            this.ascXytz = new ArmSuit();
            this.lblFightPower = new System.Windows.Forms.Label();
            this.acAlchemy = new AlchemyComponent();
            this.SuspendLayout();
            // 
            // lblArmStory
            // 
        ...
        private BasePropertyies bpcProperty;
        private FurnishTypeComponent ftcTitle;
        private MagicComponent mcBfwl;
        private MagicComponent mcGyhd;
        private MagicComponent mcFjzz;
        private MosaicComponent mcMosaic;
        private ArmSuit ascXytz;
        private System.Windows.Forms.Label lblFightPower;
        private AlchemyComponent acAlchemy;
    }
}