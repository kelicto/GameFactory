...
namespace KeLi.M3Game
{
    sealed partial class MainFrm
    {
        ...
        {
            this.mcMatch = new GameMatch();
            this.atcTask = new ActiveTask();
            this.mcMsg = new ChatMessage();
            this.glcGamer = new GamerList();
            this.rlcRoom = new RoomList();
            this.mmcMenu = new MainMenu();
            this.SuspendLayout();
            // 
            // mcMatch
            // 
        ...
        #endregion
        private MainMenu mmcMenu;
        private RoomList rlcRoom;
        private GamerList glcGamer;
        private ChatMessage mcMsg;
        private ActiveTask atcTask;
        private GameMatch mcMatch;
    }
}