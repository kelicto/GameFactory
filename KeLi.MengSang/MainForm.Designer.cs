...
namespace KeLi.MengSang
{
    sealed partial class MainForm
    {
        ...
        {
            this.mcMatch = new GameMatchControl();
            this.atcTask = new ActiveTaskControl();
            this.mcMsg = new ChatMessageControl();
            this.glcGamer = new GamerListControl();
            this.rlcRoom = new RoomListControl();
            this.mmcMenu = new MainMenuControl();
            this.SuspendLayout();
            // 
            // mcMatch
            // 
        ...
        #endregion
        private MainMenuControl mmcMenu;
        private RoomListControl rlcRoom;
        private GamerListControl glcGamer;
        private ChatMessageControl mcMsg;
        private ActiveTaskControl atcTask;
        private GameMatchControl mcMatch;
    }
}