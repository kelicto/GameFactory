...
namespace KeLi.MengSang.Forms
{
    sealed partial class HeroDataForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.PfpcPhysical = new PhysicalFurnishControl();
            this.mfpcMagic = new MagicFurnishControl();
            this.OfpcOther = new ResourcesFurnishControl();
            this.lblZhanChangShenBingValue = new System.Windows.Forms.Label();
            this.baseFurnish1 = new BaseFurnishControl();
            this.SuspendLayout();
            // 
            // lblJiChuShuXing
            // 
        ...
        private PhysicalFurnishControl PfpcPhysical;
        private MagicFurnishControl mfpcMagic;
        private ResourcesFurnishControl OfpcOther;
        private System.Windows.Forms.Label lblZhanChangShenBingValue;
        private BaseFurnishControl baseFurnish1;
    }
}