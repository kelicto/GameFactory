...
{
    sealed partial class ArmDataForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.bpcProperty = new BasePropertyiesControl();
            this.ftcTitle = new FurnishTypeControl();
            this.mcBfwl = new MagicControl();
            this.mcGyhd = new MagicControl();
            this.mcFjzz = new MagicControl();
            this.mcMosaic = new MosaicControl();
            this.ascXytz = new ArmSuitControl();
            this.lblFightPower = new System.Windows.Forms.Label();
            this.acAlchemy = new AlchemyControl();
            this.SuspendLayout();
            // 
            // lblArmStory
            // 
        ...
        private BasePropertyiesControl bpcProperty;
        private FurnishTypeControl ftcTitle;
        private MagicControl mcBfwl;
        private MagicControl mcGyhd;
        private MagicControl mcFjzz;
        private MosaicControl mcMosaic;
        private ArmSuitControl ascXytz;
        private System.Windows.Forms.Label lblFightPower;
        private AlchemyControl acAlchemy;
    }
}